...
export default function NewInvoiceForm({ clients }: { clients: any[] }) {
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <Link href="/invoices" className="inline-flex items-center gap-2 text-sm text-slate-700 hover:text-slate-900 mb-6 transition">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input name="amount"
                                    ...
                                    min="0.01"
                                    required
                                    className="w-full border border-slate-300 rounded-md pl-8 pr-3 py-2 outline-none focus:ring-2 focus:ring-blue-600 transition text-slate-900 bg-white"
                                    placeholder="0.00"
                                />
                            </div>
                        </div>
